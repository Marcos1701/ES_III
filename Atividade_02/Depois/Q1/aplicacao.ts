...
function opcoes_para_rede_social(): void {
    ...
    let id_rede_social: number = coletar_valor_valido(repo_aplicacao.usuario_logado.obter_IDs_de_redes_ja_utilizadas())
        ...
        try {
            ...
            if (op_rede_social == 7) {
                if (repo_aplicacao.Qtd_redes_usuario(repo_aplicacao.usuario_logado.id) <= 0) {
                    ...
                    id_rede_social = coletar_valor_valido(repo_aplicacao.usuario_logado.obter_IDs_de_redes_ja_utilizadas())
                }
